...
JSTPPatternComparer = {
   ...
   * 
   */
  compare: function (pattern, value, matches) {
    ...
    switch (pattern[0]) {
      ...
      case "*":
        ...
        if (pattern.length > 1) {
          ...
          return this.compare(patternClone, valueClone, matches);
        }
      ...
      case "...":
        ...
        if (typeof pattern[1] == "string" && pattern[1].length > 1 && pattern[1][0] == ":")
          throw new JSTPInvalidSyntaxForPattern(
      ...
      default: 
        ...
        if (typeof pattern[0] == "string" && pattern[0][0] == ":" && pattern[0].length > 1) {
