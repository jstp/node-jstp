...
function JSTPInvalidEndpointInAnswer(message) {
  this.name = "JSTPInvalidEndpointInAnswer";
  this.message = (message || "");
}

JSTPInvalidEndpointInAnswer.prototype = Object.create(Error);

function JSTPInvalidResourceHeaderForAnswer(message) {
  this.name = "JSTPInvalidResourceHeaderForAnswer";
  this.message = (message || "");
}

JSTPInvalidResourceHeaderForAnswer.prototype = Object.create(Error);

function JSTPInvalidToInAnswer(message) {
  this.name = "JSTPInvalidToInAnswer";
  this.message = (message || "");
}

JSTPInvalidToInAnswer.prototype = Object.create(Error);

function JSTPMissingEndpointInSubscription(message) {
  this.name = "JSTPMissingEndpointInSubscription";
  this.message = (message || "");
}

JSTPMissingEndpointInSubscription.prototype = Object.create(Error);

function JSTPInvalidResourceInSubscription(message) {
  this.name = "JSTPInvalidResourceInSubscription";
  this.message = (message || "");
}

JSTPInvalidResourceInSubscription.prototype = Object.create(Error);

function JSTPInvalidEndpointInRegular(message) {
  this.name = "JSTPInvalidEndpointInRegular";
  this.message = (message || "");
}

JSTPInvalidEndpointInRegular.prototype = Object.create(Error);

function JSTPMissingResourceInRegular(message) {
  this.name = "JSTPMissingResourceInRegular";
  this.message = (message || "");
}

JSTPMissingResourceInRegular.prototype = Object.create(Error);

function JSTPMissingMethodHeader(message) {
  this.name = "JSTPMissingMethodHeader";
  this.message = (message || "");
}

JSTPMissingMethodHeader.prototype = Object.create(Error);

function JSTPInvalidFromPatternType(message) {
  this.name = "JSTPInvalidFromPatternType";
  this.message = (message || "");
}

JSTPInvalidFromPatternType.prototype = Object.create(Error);

function JSTPInvalidToPatternType(message) {
  this.name = "JSTPInvalidToPatternType";
  this.message = (message || "");
}

JSTPInvalidToPatternType.prototype = Object.create(Error);

function JSTPNotAnEndpoint(message) {
  this.name = "JSTPNotAnEndpoint";
  this.message = (message || "");
}

JSTPNotAnEndpoint.prototype = Object.create(Error);

function JSTPMissingTransactionID(message) {
  this.name = "JSTPMissingTransactionID";
  this.message = (message || "");
}

JSTPMissingTransactionID.prototype = Object.create(Error);

function JSTPEndpointAlreadyBound(message) {
  this.name = "JSTPEndpointAlreadyBound";
  this.message = (message || "");
}

JSTPEndpointAlreadyBound.prototype = Object.create(Error);

function JSTPUnboundEndpoint(message) {
  this.name = "JSTPUnboundEndpoint";
  this.message = (message || "");
}

JSTPUnboundEndpoint.prototype = Object.create(Error);

function JSTPInvalidSyntaxForPattern(message) {
  this.name = "JSTPInvalidSyntaxForPattern";
  this.message = (message || "");
}

JSTPInvalidSyntaxForPattern.prototype = Object.create(Error);

function JSTPNotFound(message) {
  this.name = "JSTPNotFound";
  this.message = (message || "");
}

JSTPNotFound.prototype = Object.create(Error);

function JSTPNotASubscription(message) {
  this.name = "JSTPNotASubscription";
  this.message = (message || "");
}

JSTPNotASubscription.prototype = Object.create(Error);
...
module.exports = {
  ...
  JSTPInvalidEndpointInAnswer: JSTPInvalidEndpointInAnswer,
  JSTPInvalidResourceHeaderForAnswer: JSTPInvalidResourceHeaderForAnswer,
  JSTPInvalidToInAnswer: JSTPInvalidToInAnswer,
  JSTPMissingEndpointInSubscription: JSTPMissingEndpointInSubscription,
  JSTPInvalidResourceInSubscription: JSTPInvalidResourceInSubscription,
  JSTPInvalidEndpointInRegular: JSTPInvalidEndpointInRegular,
  JSTPMissingResourceInRegular: JSTPMissingResourceInRegular,
  JSTPMissingMethodHeader: JSTPMissingMethodHeader,
  JSTPInvalidFromPatternType: JSTPInvalidFromPatternType,
  JSTPInvalidToPatternType: JSTPInvalidToPatternType,
  JSTPNotAnEndpoint: JSTPNotAnEndpoint,
  JSTPMissingTransactionID: JSTPMissingTransactionID,
  JSTPEndpointAlreadyBound: JSTPEndpointAlreadyBound,
  JSTPUnboundEndpoint: JSTPUnboundEndpoint,
  JSTPInvalidSyntaxForPattern: JSTPInvalidSyntaxForPattern,
  JSTPNotFound: JSTPNotFound,
  JSTPNotASubscription: JSTPNotASubscription,
}